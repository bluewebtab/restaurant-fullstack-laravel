                ...
                <div class="col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">Total Revenue This Month: {{$estimated_income_last_30}}</span><span class="text-success float-right">+9.45%</span></p>
                        </div>
                    </div>
                </div>
            </div>
