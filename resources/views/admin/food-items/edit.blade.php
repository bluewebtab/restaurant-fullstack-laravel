                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/food-items/{{$item->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputimageurl" type="text" class="form-control form-control-lg @error('image_url', $item->image_url) is-invalid @enderror" name="image_url" value="{{ old('image_url') }}" autocomplete="title" autofocus placeholder="Add the url to the item image">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputdescription" type="text" class="form-control form-control-lg @error('description', $item->description) is-invalid @enderror" name="description" required autofocus placeholder="Write a Description">{{ old('description') }}</textarea>
