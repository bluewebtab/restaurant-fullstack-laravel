                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->title}}</td>
                                            <td>{{$item->price}}</td>
                                            <td>{{date('m/d/y', strtotime($item->id))}}</td>
                                            <td><a href="/admin/food-items/{{$item->id}}/edit"><i class="far fa-edit"></i></a></td>
                                            <td>
                                            {{-- <a href="/admin/users/{{$item->id}}/delete" onclick="if(! confirm('Are you sure you want to delete')) {return false; }"><i class="far fa-trash-alt"></i></a> --}}
