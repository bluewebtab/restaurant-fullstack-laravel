    ...
    <div id="waitlist-page">
        ...
        <div class="content-box">
            <div class="row">
                ...
                <form method="POST" action="/reservations">
                  @csrf 
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputphonenumber" type="tel" class="form-control form-control-lg @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number" autofocus placeholder="(555) 555-5555">
                ...
                <div class="col-md-6">
                    <p>
                    Please Note: This is not a reservation. You will be added tot he current wait list. You have a short wait once you arrive while we prepare your table.
                    </p>
                </div>
            </div>       
        </div>
